"""
PRD-010 Knowledge Enrichment Pipeline - Complete System Validation Test Suite (Fixed)
...
class TestPRD010PerformanceValidation:
    ...
    async def test_concurrent_task_processing_performance(self):
        ...
        config = EnrichmentConfig(max_concurrent_tasks=5)
        db_manager = Mock()
