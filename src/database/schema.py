...
def main():
    ...
    parser = argparse.ArgumentParser(description="Create AI Documentation Cache database schema")
    parser.add_argument("--db-path", default="./data/docaiche.db", help="Database file path")
