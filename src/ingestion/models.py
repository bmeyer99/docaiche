...
class DocumentUploadRequest(BaseModel):
    ...
    technology: str = Field(
        ..., description="Technology/framework this document covers"
    )
...
class BatchIngestionResult(BaseModel):
    ...
    results: List[IngestionResult] = Field(
        ..., description="Individual document results"
    )
...
class ProcessingMetrics(BaseModel):
    ...
    documents_by_format: Dict[str, int] = Field(
        default_factory=dict, description="Count by document format"
    )
    documents_by_technology: Dict[str, int] = Field(
        default_factory=dict, description="Count by technology"
    )
    ...
    quality_score_distribution: Dict[str, int] = Field(
        default_factory=dict, description="Quality score ranges"
    )
