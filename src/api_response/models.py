...
class CachedResponse(BaseModel):
    ...
    created_at: datetime = Field(default_factory=datetime.utcnow, description="The timestamp when the cache entry was created.")
    ttl: Optional[int] = Field(None, description="The time-to-live for the cache entry in seconds.")
