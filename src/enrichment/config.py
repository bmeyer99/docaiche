...
class EnrichmentConfigManager:
    ...
    def __init__(self):
        ...
        self._reload_callbacks: Dict[
            str, Callable[[EnrichmentConfig], Awaitable[None]]
        ] = {}
    ...
    async def _validate_config(self, config: EnrichmentConfig) -> None:
        ...
        try:
            ...
            if (
                config.min_confidence_threshold < 0.0
                or config.min_confidence_threshold > 1.0
            ):
                validation_errors.append(
            ...
            if validation_errors:
                error_message = "Configuration validation failed: " + "; ".join(
                    validation_errors
                )
    ...
    def register_reload_callback(
        self, name: str, callback: Callable[[EnrichmentConfig], Awaitable[None]]
    ) -> None:
        """
...
def register_config_reload_callback(
    name: str, callback: Callable[[EnrichmentConfig], Awaitable[None]]
) -> None:
    """
