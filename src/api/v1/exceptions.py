...
async def validation_exception_handler(
    ...
    return JSONResponse(status_code=422, content=problem_detail.dict())
...
async def http_exception_handler(
    ...
    error_type = error_type_map.get(
        status_code, "https://docs.example.com/errors/http-error"
    )
    ...
    return JSONResponse(status_code=status_code, content=problem_detail.dict())
...
async def global_exception_handler(request: Request, exc: Exception) -> JSONResponse:
    ...
    return JSONResponse(status_code=500, content=problem_detail.dict())
