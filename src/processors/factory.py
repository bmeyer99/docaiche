...
async def create_content_processor(
    config: Optional[ContentConfig] = None, db_manager: Optional[DatabaseManager] = None
) -> ContentProcessor:
    """
    ...
    try:
        ...
        if config is None:
            ...
            try:
                ...
                logger.warning(
                    f"Could not load system configuration, using defaults: {e}"
                )
...
def create_file_content(
    content: str, source_url: str, title: str = ""
):
    """
